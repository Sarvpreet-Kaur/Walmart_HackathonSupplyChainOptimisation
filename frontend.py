...
# Deployed FastAPI backend URL on Render
BACKEND_URL = "https://walmart-hackathonsupplychainoptimisation.onrender.com"
...
if st.button("Run Forecast") and csv_file:
    with st.spinner("Forecasting... Please wait"):
        try:
            ...
            response = requests.post(f"{BACKEND_URL}/forecast/", data=data, files=files)
